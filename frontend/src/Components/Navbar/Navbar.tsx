...
export default function Navbar() {
  ...
  return (
    <ul className="Navbar__list">
      <li>
        <NavLink className="NavLink__container" to="/allTasks">
      ...
      <li>
        <NavLink className="NavLink__container" to="/importantTasks">
          <span className="NavLink__icon">
      ...
      <li>
        <NavLink className="NavLink__container" to="/completedTasks">
          <span className="NavLink__icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
